...
이 문서는 **MVP 개발 완료, 상용제품 기능 개발** 단계에서 완료된 Physics v2 범위를 고정한다. 목표는 범용 rigid body 엔진이 아니라 Top-down Shooter와 Ferrum2D Rust core에 맞는 2D AABB 물리 계층을 제품 기능으로 안정화하는 것이다.
