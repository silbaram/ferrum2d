...
| `ScenePlacementAgentHandoffAssetFolder`, `ScenePlacementAgentHandoffAssetFile`, `ScenePlacementAgentHandoffAssetFolderDiagnostic` | desktop/local host가 선택한 asset folder 상태와 이미지 파일 evidence를 handoff에 전달하는 계약이다. |
