...
| `normalizeLightingScene(...)`, `deriveTileOccludersFromTilemapGrid(...)` | renderer lighting pass용 ambient/point light/tile occluder 데이터를 검증하고 tilemap solid rectangular run을 debug occluder로 변환한다. |
