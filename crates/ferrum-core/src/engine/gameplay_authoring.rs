...
use crate::gameplay_event::{
    GAMEPLAY_EVENT_ANIMATION_FRAME, GAMEPLAY_EVENT_COLLISION_DAMAGE,
    GAMEPLAY_EVENT_COLLISION_DESPAWN, GAMEPLAY_EVENT_INTERACTION, GAMEPLAY_EVENT_PICKUP_COLLECTED,
...
fn valid_behavior_transition_event(event_kind: u32, token_id: u32) -> bool {
    match event_kind {
        ...
        GAMEPLAY_EVENT_ANIMATION_FRAME => token_id != 0,
