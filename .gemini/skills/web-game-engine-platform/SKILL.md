...
The canonical shared skill body is `.agents/skills/web-game-engine-platform/SKILL.md`.

Before TypeScript/Web platform work, read that file and apply it as the source of truth. Do not duplicate or override the canonical workflow here.
