...
const scenarios = [
  {
    ...
    tests: [
      "physics::tests::rigid_body_step_puts_idle_dynamic_body_to_sleep",
      "physics::tests::rigid_body_island_stats_reports_active_and_sleeping_islands",
      "physics::tests::rigid_body_contact_block_solver_handles_two_point_aabb_face_contact",
    ],
  },
  {
    ...
    tests: [
      "physics::tests::rope_joint_clamps_dynamic_body_to_max_length",
      "physics::tests::spring_joint_pulls_stretched_body_toward_rest_length",
      "physics::tests::revolute_joint_moves_dynamic_anchor_to_static_anchor",
      "physics::tests::prismatic_joint_corrects_perpendicular_drift",
      "physics::tests::weld_joint_locks_local_anchor_and_relative_angle",
    ],
  },
  {
    ...
    tests: [
      "physics::tests::rigid_body_step_uses_ccd_for_fast_dynamic_aabb",
      "physics::tests::rigid_body_step_uses_ccd_for_fast_dynamic_circle_against_aabb",
      "physics::tests::rigid_body_step_uses_ccd_for_fast_dynamic_capsule_against_aabb",
      "physics::tests::rigid_body_step_uses_ccd_for_fast_dynamic_oriented_box_against_aabb",
      "physics::tests::rigid_body_step_uses_ccd_for_fast_dynamic_convex_polygon_against_aabb",
    ],
  },
  {
    ...
    tests: [
      "collision::tests::build_pairs_supports_edge_colliders",
      "collision::tests::build_contacts_supports_circle_edge_pairs",
      "collision::tests::build_contacts_supports_capsule_edge_pairs",
      "collision::tests::segment_cast_returns_edge_hit",
      "collision::tests::shape_cast_supports_capsule_shape_against_stored_edge",
    ],
  },
  {
    ...
    tests: [
      "physics::tests::carry_moving_platform_moves_grounded_rider_by_platform_delta",
      "physics::tests::platformer_controller_with_tilemap_lands_on_tile_obstacle",
      "physics::tests::platformer_controller_steps_over_low_tilemap_obstacle",
      "physics::tests::platformer_controller_snaps_up_walkable_slope",
    ],
  },
  {
    ...
    tests: [
      "collision::tests::aabb_and_circle_queries_support_convex_polygon_colliders",
      "collision::tests::raycast_returns_capsule_side_hit_with_surface_normal",
      "collision::tests::raycast_returns_edge_hit_with_surface_normal",
      "collision::tests::shape_cast_supports_convex_polygon_shape_against_stored_capsule",
      "collision::tests::shape_cast_supports_capsule_shape_against_stored_convex_polygon",
    ],
  },
];
