    ...
    try {
      ...
      if (!comparison.passed) {
        ...
        reports.push({
          ...
          message: "Platformer template replay fixture does not match the current template contract.",
...
function replayFixturePatchCandidate(actualRun, fixture) {
  return {
    ...
    message: "Current platformer template contract can be promoted to the replay fixture.",
