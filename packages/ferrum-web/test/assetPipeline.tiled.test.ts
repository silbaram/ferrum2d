    ...
    tilesets: [{
      ...
      tiles: [{
        ...
        properties: [
          ...
          { name: "floor", type: "string", value: "bridge" },
          { name: "elevation", type: "float", value: 12 },
          { name: "height", type: "float", value: 8 },
          { name: "kind", type: "string", value: "bridge" },
          { name: "blocksMovement", type: "bool", value: false },
          { name: "blocksProjectile", type: "bool", value: false },
          { name: "blocksVision", type: "bool", value: false },
          { name: "occluderHeight", type: "float", value: 6 },
        ],
      }],
    }],
    layers: [
