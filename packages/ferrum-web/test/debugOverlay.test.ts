...
test("formatDebugOverlayMetrics applies fixed labels, units, and precision", () => {
  deepEqual(formatDebugOverlayMetrics(metrics({
    ...
    physicsHd2dFilteredEntityCandidates: 2,
    physicsHd2dFilteredTileCandidates: 3,
    playerFloorId: 1,
    playerElevation: 6,
    playerHeight: 32,
    ...
    "kinematic hits: 1",
    "tile checks: 8",
    "hd2d entity filters: 2",
    "hd2d tile filters: 3",
    "player floor: 1",
    "player elevation: 6.00 world",
    "player height: 32.00 world",
    "collision pairs: 2",
    "collision events: 3",
