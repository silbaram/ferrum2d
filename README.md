...
| `FrameState` | 한 frame의 점수, 카메라, sprite, audio, physics debug 정보를 담는다. |
| Bulk buffer ABI | render/audio/collision/physics 데이터를 숫자 buffer로 한 번에 넘긴다. |
...
| Minimal starter | 가장 작은 runtime 사용 예제다. |
