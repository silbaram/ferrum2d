...
- sweep-and-prune broadphase와 swept AABB 기반 빠른 bullet/enemy 터널링 방지
...
패키지 공개 후보의 entrypoint, 포함 파일, generated Wasm artifact 구성을 확인한다.
