...
| Authoring primitive | `@ferrum2d/ferrum-web/authoring` | 장르와 템플릿이 조합해 쓰는 데이터 기반 primitive다. | Scene Composition, Data Scene spawn/role/handle registry helper, Behavior Recipe, projectile/weapon authoring, FSM install/replay, presentation effect registry |
